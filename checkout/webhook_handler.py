...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        """
        Send confirmation email on order completion
        """
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if description != 'Subscription update':
            ...
            # Update profile information on save checked
            profile = None
            ...
            return HttpResponse(
                content=f'Webhook received: {event["type"]} | SUCCESS: Other checkout method',
                status=200)
